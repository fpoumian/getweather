...
export const formatLocationData = (rawLocationData) => {
  const localityLongName = rawLocationData.locality.longName
  const countryLongName = rawLocationData.country.longName
  const adminLongNAme = rawLocationData.administrativeAreaLevel1.longName
  return `${localityLongName}, ${adminLongNAme}, ${countryLongName}`
}
